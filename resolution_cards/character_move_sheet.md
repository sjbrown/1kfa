...
✷ Add an extra Might roll
 ...
 Without a melee weapon, a character deals 1 Might instead of rolling.
...
# Volley (Dex) ([])
    **Levels**: 0 | g1
    ...
    ✗: 
    ----
    ✓: Roll Might. GM chooses an option.
    ----
    ✔: Roll Might. Choose an option
    ----
    ✔✔: Roll Might.
    ----
...
✷ Roll Might against the attacker

 This move can interrupt an attack against an ally if you are in range and Might has not yet been rolled.
...
# Discern (Int) ([])
    **Levels**: 
    ...
    ----
    **Details**: Closely study a situation or person, ask the GM your question(s), and gain a +1 advantage when acting on the answers. (Place tokens to remember where the advantages are, as appropriate)
...
# Where It Hurts (DEX/STR) (['IMMEDIATE'])
    **Levels**: r1 | 0 | g1
    ----
    ✗: Shadow point
    ----
...
# Fury (STR) (['IMMEDIATE'])
    **Levels**: r2 | r1 | 0 | g1 | g2
    ...
    ✓: 1 Might
    ----
    ✔: Add another Might roll, divided by 2
Turn this card face-down until you Take a Breather
    ----
    ✔✔: Add another Might roll
Turn this card face-down until you Take a Breather
    ----
...
Thereafter, when anyone attacks this weakness, they add 1d4 Might
...
# Use a Magic Item (INT) (['RECEIVE CARDS'])
    **Levels**: r2 | r1 | 0 | g1 | g2
    ----
...
# Entreat the Blood-Bound () (['RECEIVE CARDS'])
    **Levels**: 
    ----
    ✗: 
    ----
...
# Channel the Living Light (INT) (['RECEIVE CARDS'])
    **Levels**: r2 | r1 | 0 | g1
    ----
    ✗: GM Move
    ----
